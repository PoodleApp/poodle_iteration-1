...
export type Verb = 'post' | 'share' | 'edit' | 'like'
...
function asNote(message: Message): Zack {
  ...
  var contentPart = textParts(message)[0] || htmlParts(message)[0]
  ...
  var activity = {
    ...
    object: {
      objectType: 'note',
      author,
      uri: midPartUri(contentPart, message),
    }
  }
  return [activity, message]
}
