...
import { MyContentOptsMenu } from '../../client/lib/components/activities'
import { FlatButton
       , IconButton
       , IconMenu
       , Paper
...
function textContent(activity: DerivedActivity): ?string {
  var content = Act.objectContent(activity)[0]
  if (content && content.contentType.startsWith('text/')) {
